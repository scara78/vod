  ...
  <div>
    <v-toolbar color="#363e49" v-if="small">
      ...
      <v-toolbar-title @click="$router.push('/')">
        <img src="/img/logo.png" style="max-height: 5em" alt="WATCH ONLINE WITHOUT DOWNLOADING logo" />
      </v-toolbar-title>
      <v-spacer></v-spacer>
      ...
      <v-toolbar flat class="transparent">
        <v-list class="pa-0">
          <v-list-tile avatar @click.stop="mini = !mini">
            ...
            <v-list-tile-content>
              <v-list-tile-title>WATCH ONLINE WITHOUT DOWNLOADING</v-list-tile-title>
            </v-list-tile-content>
